export const TimelineCard = ({ date, title, description }) => {
    return (
        <div className="max-w-lg shadow-lg transform transition hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-zinc-800/50  backdrop-blur-lg border border-zinc-600/60 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0 scroll-reveal">
